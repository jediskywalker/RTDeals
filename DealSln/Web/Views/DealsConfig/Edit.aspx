<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Web.Models.DealsConfigModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
    <%foreach (Web.Models.DealsSourceModel dsm in (List<Web.Models.DealsSourceModel>)ViewData["DealSource"])
      {%>
          <tr>
             <td>
